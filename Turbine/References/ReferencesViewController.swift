...
class ReferencesViewController: UIViewController {
    ...
    private func setTextLabel() {
        ...
        reference2Label.text = "Biffl M., Moore EE, Offner PJ, et al. Blunt carotid arterial\ninjuries: implications of a new grading scale. L Trauma\n1999; 47:845."
        reference3Label.text = "Miller PR., Fabian TC., Croce MA, et al. Prospective\nscreening for blunt cerebrovascular injuries. Ann Slurg,\n2002; 22: 234."
